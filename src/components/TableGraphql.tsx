...
export default function TableGraphql({ reports }: any) {
    return (
                ...
                <tbody>
                    {reports.map((report: any) => (
                        <tr key={report.id}>
                            ...
                            <td>{report.email}</td>
                            <td>
                                <span className="badge badge-soft badge-success text-xs me-2">{report.service.name}</span>
                                {report.serviceType && (
                                    <span className="badge badge-soft badge-warning text-xs">{report.serviceType.name}</span>
                                )}
                            </td>
                            <td className="text-nowrap">{report.noHandphone}</td>
                            <td>
